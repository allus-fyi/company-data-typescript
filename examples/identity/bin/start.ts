...
/**
 * One-command launcher for the identity example (`npm start`).
 *
 * Steps:
...
const base = dirname(dirname(fileURLToPath(import.meta.url))); // examples/identity
process.chdir(base);

async function main(): Promise<void> {
  log('identity example — starting up');
